		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Codigo de producto</label>
				  	<input class="input" type="text" name="producto_id" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/  ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Detalles del Producto</label>
				  	<input class="input" type="text" name="producto_detalle" pattern="[a-zA-Z0-9- ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Color del Producto</label>
				  	<input class="input" type="text" name="producto_color" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		</div>
		<form action="./php/producto_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Tamaño del producto</label>
				  	<input class="input" type="text" name="producto_tamaño" pattern="[a-zA-Z0-9- ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Precio Compra Unidad</label>
				  	<input class="input" type="text" name="precio_compra_unidad" pattern="[a-zA-Z0-9-.-0-9 ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Fecha de Ingreso</label>
				  	<input class="input" type="text" name="fecha_de_ingreso" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
